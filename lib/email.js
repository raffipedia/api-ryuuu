    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api Ryuu - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=62858887391620">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Ryuu</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Ryuu" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Ryuu`,
        html: inboxGmail,
      };
